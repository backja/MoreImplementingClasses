...
class Line(object):
    ...
    def __init__(self, start, end):
        ...
        self.end = end.clone()
        self.clones = 0
        self.start_orginial =start.clone()
        self.end_orginial =  end.clone()
    ...
    def clone(self):
        ...
        #        They include the Example in the above doc-string.
        # --------------------------------------------------------------
        clone_line = Line(self.start.clone(),self.end.clone())
    ...
    def reset(self):
        ...
        #        They include the Example in the above doc-string.
        # --------------------------------------------------------------
        self.start = self.start_orginial
        self.end = self.end_orginial
